...
experience:
  - company: "Brandis"
    ...
    summary:
      - "Participate from the project start, architecture the system and built most of its backend/infrastructure parts."
      - "Owned the platform from architecture through operations as the technical lead."
      ...
      - "Defined WebSocket protocol and partner APIs; guided integrations end-to-end."
    breakdown: |
      ...
      **How I built it.**
      ...
      - **Reactor core:** CRDT-based counters and triggers to support new mechanics without rewrites.
  ...
  - company: "Lingualeo"
    ...
    location: "Moscow, RU"
    summary:
      - "Led backend team and prepare SOA migration."
