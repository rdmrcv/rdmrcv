...
kicker: "Low latency Go backends built for scale."
ogDescription: |
...
experience:
  - company: "Brandis"
    ...
    summary:
      ...
      - "Formed observability stack: VictoriaMetrics & Grafana to bring transparency about the system's state."
  ...
  - company: "Earlier roles"
    ...
    stack:
      ...
      - "HTML/CSS"
---
I build and operate the backends behind low-latency products, from architecture to operations. I favor simple Go services that keep throughput predictable, tail-latency low, and costs stable as traffic grows. At Brandis, I built WebSocket infrastructure for ~400k concurrent users and a Kafka→ClickHouse pipeline ingesting ~1M events/day, while shaping product scope and API contracts with partners.
